...
export function GameLayout({ mode, title, description, progress, progressLabel, children }: {
  ...
  return <div className="mx-auto max-w-6xl px-4 py-6 sm:px-8 sm:py-10">
    <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
      <Link to="/" className="inline-flex items-center gap-1.5 rounded-lg text-sm font-bold text-muted hover:text-ink focus-visible:outline-2 focus-visible:outline-offset-4"><Icon name="arrowLeft" size={16} />Back to your journey</Link>
